...
def create_service(request):
    ...
    if request.method == "POST":
        ...
        messages.success(request, 'muvoffaqiyatli qo`shildi')
...
def edit_service(request, id):
    ...
    if request.method =='POST':
        ...
        service.save()
        messages.success(request, 'muvoffaqiyatli tahrirlandi')
...
def create_price(request):
    ...
    if request.method == "POST":
        ...
        messages.success(request, 'Muvoffaqiyatli qoshildi')
...
def log_in(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            messages.error(request, 'Parol yoki loginni qaytadan kriting')
